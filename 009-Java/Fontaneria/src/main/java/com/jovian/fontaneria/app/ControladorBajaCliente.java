...
public class ControladorBajaCliente {
	...
	@FXML private Button btnBorrarCliente;
...
//*******************************************************************************************************************************************************
	...
	private void buscarCliente() throws SQLException {
		...
		if(btnId.equals("ningunBoton")) {
			...
			btnBuscarDni.setDisable(true);
			btnBuscarNombre.setDisable(true);
			btnBorrarCliente.setDefaultButton(false);
...
//*******************************************************************************************************************************************************
	...
	@FXML public void borrarCliente(ActionEvent event) throws SQLException {
		...
		alert.setContentText("¿Esta seguro que quiere borrar el cliente?");
