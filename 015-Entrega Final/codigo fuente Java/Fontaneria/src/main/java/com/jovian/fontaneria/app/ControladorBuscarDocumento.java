...
public class ControladorBuscarDocumento {
  ...
  //*******************************************************************************************************************************************************
  	...
  	@FXML public void initialize() throws SQLException {
  		...
  		//indicamos el tipo de valor que va a almacenar cada una de las celdas de las tablas
  		...
  		//construimos las columnas de la tablas
  ...
  //*******************************************************************************************************************************************************
   /**
    * metodo para buscar las facturas de un cliente
    * @param event recoge el evento del botón
    * @throws SQLException recoge excepciones SQL
    */
  ...
  //*******************************************************************************************************************************************************
    /**
     * metodo que permite acceder a la escena de busqueda de clientes
     * @param event recoge el evento del boton
     * @throws SQLException recoge excepciones SQL
     * @throws IOException recoge excepciones IO
     */
  ...
  //*******************************************************************************************************************************************************
    /**
     * metodo para mostrar en pantalla todos las facturas
     * @param event recoge ele evento del boton
     * @throws SQLException recoge excepciones SQL
     */
  ...
  //*******************************************************************************************************************************************************
  	...
  	/**
  	 * metodo con las sentencia sql para poder consultar todos los presupuestos en la BBDD
  	 * @throws SQLException control de excepciones SQL
  	 */
  ...
  //*******************************************************************************************************************************************************
    /**
     * metodo para poder mostrar en pantalla todos los materiales y trabajos que forman parte del presupuesto
     * @param event recoge el evento del boton
     * @throws SQLException
     */
    ...
    //*******************************************************************************************************************************************************
    /**
     * metodo para imprimir un albaran      
     * @param event recoge el evento del boton
     * @throws SQLException recoge el evento SQL
     * @throws ClassNotFoundException evento 
     * @throws JRException evento
     */
